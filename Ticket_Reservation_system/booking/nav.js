...
$("#details").html("Transaction ID: "+code+"<br/> <ul><li>TITULAR: "+fullname+"</li><li>DESTINO: "+destination+"</li><li>FECHA DE VIAJE: "+traveldate+"</li><li>CLASE DE VIAJE: "+travelclass+"</li><li>NUMERO DE ASIENTOS: "+seats+"</li><li>MONTO DE PAGO: "+amount+"</li><li>VIA DE PAGO "+paymethod+" Transaction ID: "+code+"</li></ul>");	
